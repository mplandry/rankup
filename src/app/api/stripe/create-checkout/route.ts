      ...
      line_items: [
        {
          price_data: {
            currency: 'usd',
            product_data: {
              name: pricing.plan === 'monthly' ? 'RankUp Monthly Subscription' :
                    pricing.plan === 'exam_prep' ? 'RankUp Exam Prep Bundle' :
                    'RankUp Department Rate',
              description: pricing.plan === 'monthly' ? 'Full access to all study materials' :
                          pricing.plan === 'exam_prep' ? 'One-time payment - access until April 7, 2026' :
