...
export default function QuestionCard({
  ...
  return (
    <div className='bg-white border border-gray-200 rounded-xl p-4 sm:p-6 mb-4'>
      ...
      {/* Question text */}
      <p className='text-[#1B2A4A] font-medium text-base sm:text-lg leading-relaxed mb-5'>
        ...
        {OPTIONS.map((opt) => {
          ...
          return (
            <button
              ...
              disabled={submitted}
              className={cn(
                "w-full flex items-center gap-3 p-3.5 sm:p-4 rounded-lg border-2 text-left transition-all",
                optClass,
              )}
            >
              <span
