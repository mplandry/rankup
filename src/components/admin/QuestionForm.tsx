...
export default function QuestionForm({ question, mode }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const url =
      mode === "create" ? "/api/questions" : `/api/questions/${question!.id}`;
        ...
        <div className='grid grid-cols-2 gap-4'>
          ...
          <Field label='Page Start'>
            <input
              ...
              onChange={(e) =>
                set("page_start", parseInt(e.target.value) || null)
              }
              className={inputCls}
            />
          </Field>
          <Field label='Page End'>
            <input
              ...
              value={form.page_end || ""}
              onChange={(e) =>
                set("page_end", parseInt(e.target.value) || null)
              }
              className={inputCls}
            />
          </Field>
