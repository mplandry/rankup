        ...
        <div className="bg-green-50 border border-green-200 rounded-xl p-5 flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-sm text-green-700">
              Successfully imported <strong>{importResult.inserted}</strong> questions
            </div>
          </div>
        </div>
      )}
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className={`border rounded-lg p-4 flex items-center gap-3 ${
              parseResult.errors.length > 0 ? 'bg-red-50 border-red-200' : 'bg-gray-50 border-gray-200'
            }`}>
          ...
          {parseResult.errors.length > 0 && (
            <div className="bg-red-50 border border-red-200 rounded-xl p-4">
              ...
              <p className="text-xs text-red-600 mt-2">
                Fix these errors in your CSV and re-upload. Only valid rows are shown above.
              </p>
            </div>
          )}
